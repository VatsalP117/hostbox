...
export interface Deployment {
  ...
  build_serving_mode: string | null;
  build_package_manager: string | null;
  build_package_manager_version: string | null;
  build_node_version: string;
  build_root_directory: string;
  build_output_directory: string | null;
  build_install_command: string | null;
  build_command: string | null;
  build_lock_file_hash: string;
  build_manifest_resolved: boolean;
  source_repository: string | null;
  source_installation_id: number | null;
